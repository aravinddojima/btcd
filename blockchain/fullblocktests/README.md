...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/dojimachain/btcd/blockchain/fullblocktests)
...
```bash
$ go get -u github.com/dojimachain/btcd/blockchain/fullblocktests
```
