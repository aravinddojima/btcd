...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/dojimachain/btcd/mining/cpuminer)
=======
...
```bash
$ go get -u github.com/dojimachain/btcd/mining/cpuminer
```
