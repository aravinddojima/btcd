...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/github.com/dojimachain/btcd/btcutil/coinset)
...
```bash
$ go get -u github.com/dojimachain/btcd/btcutil/coinset
```
