...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](https://pkg.go.dev/github.com/aravinddojima/btcd/connmgr)
...
```bash
$ go get -u github.com/aravinddojima/btcd/connmgr
```
